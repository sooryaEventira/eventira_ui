      ...
      >
        <div className="flex flex-col flex-1 overflow-hidden">
          ...
          <div className="shrink-0 flex items-center justify-between border-b border-slate-200 px-6 py-4">
            <h2 id="slideout-title" className="text-lg font-semibold text-slate-900">
          ...
          <div className="flex-1 overflow-y-auto px-6 py-8">
            <div className="space-y-5">
              <div>
                <label htmlFor="broadcast-title" className="flex w-full flex-col gap-1">
                  ...
                  <input
                    ...
                    className="w-full rounded-lg border border-slate-300 px-3 py-2.5 text-sm text-slate-900 shadow-sm placeholder:text-slate-400 focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20"
                  />
                </label>
              </div>
