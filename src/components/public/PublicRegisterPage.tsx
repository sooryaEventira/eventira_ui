  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="relative px-3 pb-10 pt-6 sm:px-6 sm:pb-12 sm:pt-10">
        {/* Fixed below the h-16 topbar so it sits at the visual top-left of the page */}
        <button
          type="button"
          onClick={handleBack}
        ...
        <div className="mx-auto mt-10 w-full max-w-lg sm:mt-14">
          <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-md sm:p-8">
            ...
            <p className="mt-1 text-center text-sm font-normal leading-5 text-slate-500">Enter your email to continue.</p>

            <form onSubmit={handleSignupSubmit} className="mt-5 space-y-4 sm:mt-6">
